...
tc_i386_fix_adjustable (fixS *fixP ATTRIBUTE_UNUSED)
{
  ...
  if (fixP->fx_r_type == BFD_RELOC_SIZE32
      ...
      || fixP->fx_r_type == BFD_RELOC_386_RELAX_GOT32
      ...
      || fixP->fx_r_type == BFD_RELOC_X86_64_RELAX_GOTPCREL
			    ...
			    i386_operand_type types, const char *disp_start)
{
  ...
  if (i.reloc[this_operand] == BFD_RELOC_386_GOTOFF
	...
	i.reloc[this_operand] = BFD_RELOC_32;
	   ...
	   && i.types[this_operand].bitfield.jumpabsolute)
    i.reloc[this_operand] = BFD_RELOC_386_RELAX_GOT32;
  ...
  if (fixp->fx_subsy && fixp->fx_subsy == GOT_symbol)
      ...
      else if (fixp->fx_r_type == BFD_RELOC_X86_64_PC32_BND)
	{
	  /* Covert the borrowed BFD_RELOC_X86_64_PC32_BND back to
	     BFD_RELOC_X86_64_RELAX_GOTPCREL.  */
	  if (!object_64bit)
	    abort ();
	  fixp->fx_r_type = BFD_RELOC_X86_64_RELAX_GOTPCREL;
	}
...
tc_gen_reloc (asection *section ATTRIBUTE_UNUSED, fixS *fixp)
{
  ...
  switch (fixp->fx_r_type)
    ...
    case BFD_RELOC_X86_64_GOT32:
    case BFD_RELOC_X86_64_GOTPCREL:
    case BFD_RELOC_X86_64_RELAX_GOTPCREL:
    case BFD_RELOC_386_PLT32:
    case BFD_RELOC_386_GOT32:
